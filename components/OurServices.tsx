        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "80px" }}>
          <h2 style={{ 
            ...
            <div style={{ 
              ...
              <Image src="/images/829-600x600.jpg" alt="Team" fill style={{ objectFit: "cover" }} />
            </div>
            Services
          </h2>
              ...
              <AnimatePresence>
                {hoveredService === service.id && (
                  ...
                  >
                    ...
                    />
                    <div style={{ position: "relative", zIndex: 2, display: "flex", alignItems: "center", gap: "30px", color: "#fff" }}>
                      <span style={{ fontSize: "80px", fontWeight: "300" }}>↗</span>
                      <span style={{ fontSize: "60px", fontWeight: "700", letterSpacing: "-0.03em" }}>{service.name}</span>
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
